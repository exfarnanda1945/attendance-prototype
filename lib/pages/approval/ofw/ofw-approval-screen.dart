...
class OfwApprovalScreen extends StatelessWidget {
  const OfwApprovalScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(title: "Out From Work", useArrowBack: true),
      floatingActionButton:
      FloatingActionButton(onPressed: () {
        context.pushNamed("ofw-add-edit");
